...
export const mockDailyTracks: RecommendSong[] = [
  {
    ...
    song: {
      ...
      songSinger: "Oasis",
      songImage: "/public/오아시스.jpg",
      songVoiceFileUrl: "/public/songs/wonderwall.mp3",
      songDuration: "4:18",
      songWriter: "Oasis",
  ...
  },
  {
    ...
    song: {
      ...
      songImage: "/public/에드시런.jpg",
      songVoiceFileUrl: "/public/songs/perfect.mp3",
      songDuration: "4:23",
...
export const mockWeeklyTracks: RecommendSong[] = [
  {
    ...
    song: {
      ...
      songTitle: "Sugar",
      songSinger: "Maroon 5",
      songImage: "/public/maroon5.jpg",
      songVoiceFileUrl: "/public/songs/sugar.mp3",
      songDuration: "3:55",
      songWriter: "Maroon 5",
  ...
  },
  {
    ...
    song: {
      ...
      songTitle: "봄날",
      songSinger: "방탄소년단",
      songImage: "/public/bts.jpg",
      songVoiceFileUrl: "/public/songs/spring_day.mp3",
      songDuration: "4:36",
      songWriter: "방탄소년단",
...
export const mockMonthlyTracks: RecommendSong[] = [
  {
    ...
    song: {
      ...
      songTitle: "Crooked",
      songSinger: "G-DRAGON",
      songImage: "/public/GD_profile.jpg",
      songVoiceFileUrl: "/public/songs/crooked.mp3",
      songDuration: "3:44",
      songWriter: "G-DRAGON",
  ...
  },
  {
    ...
    song: {
      ...
      songImage: "/public/투모로우바이투게더.jpg",
      songVoiceFileUrl: "/public/songs/blue_hour.mp3",
      songDuration: "3:27",
