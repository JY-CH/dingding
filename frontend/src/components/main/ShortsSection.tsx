        ...
        {mockShorts.map((short) => (
          ...
          >
            ...
            `}>
              ...
              `}>
                <button className="w-12 h-12 flex items-center justify-center bg-amber-500 rounded-full text-white
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4">
                ...
                `}>
                  <p className="text-white text-sm font-medium line-clamp-2 mb-1.5">{short.title}</p>
