      ...
      {isAllNotificationsModalOpen && (
        ...
        >
          ...
          >
              ...
              <div className="p-6 border-b border-white/5">
                ...
                <div className="space-y-4">
                  <NotificationItem
                    icon={
                      <div
                        className="w-10 h-10 rounded-xl bg-gradient-to-br from-amber-500/20 to-amber-600/20 
                  ...
                  <NotificationItem
                    icon={
                      <div
                        className="w-10 h-10 rounded-xl bg-gradient-to-br from-green-500/20 to-green-600/20 
              ...
              <div className="p-6 border-b border-white/5">
                ...
                <div className="space-y-4">
                  <NotificationItem
                    icon={
                      <div
                        className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500/20 to-blue-600/20 
            ...
            {/* 모달 푸터 */}
            <div
              className="p-6 border-t border-white/10 bg-gradient-to-b from-zinc-900/50 to-zinc-900/80 
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <button
                  className="px-6 py-2.5 bg-gradient-to-r from-amber-500 to-amber-600 
...
const NotificationItem: React.FC<NotificationItemProps> = ({
  ...
  return (
    <div
      className="flex items-start gap-4 p-4 rounded-xl hover:bg-white/5 
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          ...
          {isNew && (
            <span
              className="px-2 py-0.5 rounded-full bg-amber-500/10 text-amber-500 
              text-xs font-medium"
            >
              New
            </span>
      ...
      <button
        className="absolute right-4 top-4 p-1.5 rounded-lg bg-white/5 opacity-0 
